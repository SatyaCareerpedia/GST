...
function calculate() {
  ...
  if (!isNaN(amount)) {
    ...
    if (5000 < amount) {
      document.getElementById("final").innerHTML = `With tip 1000 rupees : ${bill + amount + 1000}/-<br><br>Note : bill exceeds 5000 then will only pay 1000 rupees in tip otherwise will pay 500 rupees in tip`;
    } else {
      document.getElementById("final").innerHTML = `With tip 500 rupees : ${bill + amount + 500}/-<br><br>Note : bill exceeds 5000 then will only pay 1000 rupees in tip otherwise will pay 500 rupees in tip`;
    }
  }
